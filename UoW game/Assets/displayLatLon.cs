namespace Mapbox.Examples
{
    ...
    public class displayLatLon : MonoBehaviour
    {
        ...
        public PhotonNetworkManager pm;
        [SerializeField]
        ...
        void Awake()
        {
            ...
            {
                // o = pm.player;
               // _referenceCamera = pm.player.transform.GetChild(4).GetComponent<Camera>();
                _referenceCamera=GetComponent<Camera>();
                // _referenceCamera = pm.miniCamera;
        ...
        PhotonNetworkManager p;
        void UseMeterConversion()
        {
            //if (Input.GetKeyDown("w") || Input.GetKeyDown("a") || Input.GetKeyDown("s") || Input.GetKeyDown("d") || Input.GetKeyDown("up") || Input.GetKeyDown("down") || Input.GetKeyDown("left") || Input.GetKeyDown("right"))
            if(Application.isPlaying)
            {
               ...
               // Debug.Log("Latitude: " + latlongDelta.x + " Longitude: " + latlongDelta.y);
                ...
                txt.text = "Latitude:" + latlongDelta.x.ToString() + ", Longitude: " + latlongDelta.y.ToString();
        ...
        private void Update()
        {
          // txt.text = "Latitude:" + latlongDelta.x.ToString() + ", Longitude: " +latlongDelta.x.ToString(); 
        }
